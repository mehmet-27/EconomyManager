...
@CommandPermission("economymanager.command.give")
public class GiveCommand extends BaseCommand {
	...
	public void give(CommandIssuer sender, OfflinePlayer player, BigDecimal amount) {
		EconomyPlayer economyPlayer = cacheManager.getEconomyPlayer(player.getUniqueId());
		economyPlayer.giveBalance(amount);
		Utils.sendMessage(sender.getUniqueId(), "command.give.done", message -> message
		...
		Utils.sendMessage(player.getUniqueId(), "command.give.message", message -> message
